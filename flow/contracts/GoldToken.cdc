// GoldToken.cdc
//
// The GoldToken contract is a sample implementation of a fungible token on Flow.
//
...
pub contract GoldToken {
    ...
    pub resource VaultMinter {
        ...
        pub fun mintTokens(amount: UFix64, recipient: Capability<&AnyResource{Receiver}>) {
            ...
            GoldToken.totalSupply = GoldToken.totalSupply + UFix64(amount)
